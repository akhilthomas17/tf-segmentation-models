...
flags.DEFINE_integer('train_batch_size', 14,
...
def _build_deeplab(iterator, outputs_to_num_classes, ignore_label):
  ...
  samples[common.IMAGE] = tf.identity(image, name=common.IMAGE)
  samples[common.LABEL] = tf.identity(label, name=common.LABEL)
